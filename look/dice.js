...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-2f3a0865');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-2f3a0865');}
...
var brandEl=document.querySelector('.rl-brand-2f3a0865');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
